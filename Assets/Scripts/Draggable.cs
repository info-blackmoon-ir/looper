...
public class Draggable : MonoBehaviour
{
    ...
    private ColorIndicator theColorIndicator;
    private Color outputColor;

    private void Start()
    {
        theColorIndicator = GameObject.FindObjectOfType<ColorIndicator>();
    }
    ...
    void FixedUpdate()
	{
        ...
        {
            dragging = false;
            outputColor = theColorIndicator.GetComponent<MeshRenderer>().material.color;
            print(outputColor);
        }
